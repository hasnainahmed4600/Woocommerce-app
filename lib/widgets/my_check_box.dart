...
class _MyCheckBoxState extends State<MyCheckBox> with TickerProviderStateMixin {
...
const double _kEdgeSize = MyCheckBox.width;
const Radius _kEdgeRadius = Radius.circular(3);
