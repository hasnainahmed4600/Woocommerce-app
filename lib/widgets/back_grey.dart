...
class MyBackGreyButton extends StatelessWidget {
  final VoidCallback onButtonPressed;
  final double horizontalMargin;
  final double bottomMargin;
  final double topMargin;
  const MyBackGreyButton({Key key,this.onButtonPressed,this.horizontalMargin, this.bottomMargin, this.topMargin}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: RaisedButton(
          ...
          elevation: 0,
          child: Center(
            child: Image.asset(ImageUtils.backGrey,width: 4.5.toImage(),height: 4.5.toImage(),),
          )
      ),
    );
  }
